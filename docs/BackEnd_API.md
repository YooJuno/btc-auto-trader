...
- `GET /api/strategy`, `GET /api/strategy/presets`는 비로그인 조회가 가능합니다.
...
[
  {
    ...
    "details": {
      ...
      "bollingerMiddle": 104000000,
      "bollingerUpper": 105500000,
      "bollingerLower": 102500000,
      "bollingerBandwidthPct": 2.9,
      "bollingerPercentB": 0.83,
      "feeRate": 0.0005,
      "slippagePct": 0.001,
